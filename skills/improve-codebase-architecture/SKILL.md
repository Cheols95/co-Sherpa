...
Use these terms exactly in every suggestion. Consistent language is the point — don't drift into "component," "service," "API," or "boundary." **[LANGUAGE.md](LANGUAGE.md) owns the full glossary and principles** (Module, Interface, Implementation, Adapter, the interface-is-the-test-surface and one-vs-two-adapter rules…); the terms the Process below leans on most:

- **Depth** — leverage at the interface: a lot of behaviour behind a small interface. **Deep** = high leverage. **Shallow** = interface nearly as complex as the implementation.
- **Seam** — where an interface lives; a place behaviour can be altered without editing in place. (Use this, not "boundary.")
- **Leverage / Locality** — what depth buys: leverage for callers, locality for maintainers (change, bugs, knowledge concentrated in one place).
