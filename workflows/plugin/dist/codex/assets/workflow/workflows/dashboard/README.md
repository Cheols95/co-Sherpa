...
```bash
bash workflows/dashboard/engines/roadmap.sh
```

The command writes `workflows/dashboard/roadmap.html`. The file is generated output and is
...
```bash
bash workflows/dashboard/engines/roadmap-selftest.sh
