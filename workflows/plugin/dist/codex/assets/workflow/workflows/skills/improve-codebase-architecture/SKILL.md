...
description: "코드베이스의 deepening(얕은 모듈을 깊게 만들기) 기회를 CONTEXT.md의 도메인 언어와 workflows/docs/adr/의 결정에 비추어 찾는다. 아키텍처 개선, 리팩토링 기회 발굴, 강결합 모듈 통합, 또는 코드베이스를 더 테스트 가능·AI-탐색 가능하게 만들고 싶을 때 활성화."
---
