...
priority: P1
related:
  - workflows/dashboard/engines/roadmap.sh
  - workflows/docs/spec/data-schema.md
---
...
관측: active=workflows/goals/3-search.md 상태에서 005가 `gate:""`로, dep "004"가 별도 노드로
...
`workflows/dashboard/engines/roadmap-selftest.sh`의 deps 그룹에 **의존성 2개 이상인 픽스처 이슈**를
