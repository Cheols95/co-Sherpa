...
# workflows-coSherpa/.cosherpa/workflow-version belongs to PROJECT copies (template-SHA reconcile marker,
# written by workflows-coSherpa/scripts/update-workflow.sh) -- the template itself must not
