...
ADRs live in `workflows-coSherpa/docs/adr/` and use sequential numbering: `0001-slug.md`, `0002-slug.md`, etc.

Create the `workflows-coSherpa/docs/adr/` directory lazily — only when the first ADR is needed.
...
Scan `workflows-coSherpa/docs/adr/` for the highest existing number and increment by one.
